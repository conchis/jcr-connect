...
def setup_product():
    ...
    import northwestern.jcr.explorer
    zcml.load_config('configure.zcml', northwestern.jcr.explorer)
    ...
    ztc.installPackage('northwestern.jcr.explorer')
...
setup_product()
ptc.setupPloneSite(products=['northwestern.jcr.explorer'])
