...
import edu.northwestern.jcr.adapter.fedora.query.ScoreNode;
 ...
 * existing Fedora repository, this search index manager is written to
...
public class SearchIndex extends AbstractQueryHandler {
	 ...
	 * {@link FedoraQuery} object is already populated with query results.
	 *
		...
		throws IOException 
	{
		...
		return new QueryHitsAdapter(new FedoraQueryHits(result), 
