...
// Note that this must be the first test run without
// specified node ids.
test("generated ids", function () {
	var c1 = makeCategory({title: "Category 1"});
	var c2 = makeCategory({title: "Category 2"});
	var c3 = makeCategory({title: "Category 3"});	
...
test("isRoot and depth", function () {
	var c1 = makeCategory({title: "Category 1"});
	var c2 = makeCategory({title: "Category 2"});
	var c3 = makeCategory({title: "Category 3"});
	var c4 = makeCategory({title: "Category 4"});
	c1.add(c2);
	c2.add(c3);
	c2.add(c4);
	
	ok(c1.isRoot(), "isRoot(c1)");
	ok(!c2.isRoot(), "!isRoot(c2)");
	ok(!c3.isRoot(), "!isRoot(c2)");
	ok(!c4.isRoot(), "!isRoot(c2)");
